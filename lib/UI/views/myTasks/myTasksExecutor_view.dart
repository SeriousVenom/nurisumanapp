...
class MyTasksExecutorView extends StatelessWidget {
  const MyTasksExecutorView({Key? key}) : super(key: key);
                      ...
                      return Stack(
                        children: [
                          ...
                          Align(
                              ...
                              child: Padding(
                                padding:
                                    const EdgeInsets.only(right: 10, top: 17),
                                child:
