...
class CreateTaskMapView extends StatelessWidget {
  const CreateTaskMapView({Key? key}) : super(key: key);
...
_createTaskMap(BuildContext context, CreateTaskViewModel model) {
  return Container(
        ...
        ListView(
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 20, top: 10),
              child: Text(
                'Или поставьте метку на карте',
                style: TextStyle(
                    color: Color.fromRGBO(51, 62, 99, 1), fontSize: 14),
              ),
            ),
            Container(
