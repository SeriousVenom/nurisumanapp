...
class ProfileViewCustomerRoute extends MaterialPageRoute {
  ProfileViewCustomerRoute()
      : super(builder: (context) => const ProfileCustomerView());
}

class ProfileCustomerView extends StatelessWidget {
  const ProfileCustomerView({Key? key}) : super(key: key);
