...
class CreateProfileSellerView extends StatelessWidget {
  const CreateProfileSellerView({Key? key}) : super(key: key);
          ...
          children: <Widget>[
            ...
            Stack(
              children: [
                ...
                const Padding(
                  padding:
                      EdgeInsets.only(left: 65, right: 30, top: 10, bottom: 15),
                  child: Text(
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => LoadingScreen(index: 2)));
                },
                child: const Text(
                  'создать',
                  style: TextStyle(
